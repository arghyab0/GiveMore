...
class DistRegister extends StatefulWidget {
  // final Function toggleView;
  // DistRegister({this.toggleView});
  @override
  _DistRegisterState createState() => _DistRegisterState();
}

class _DistRegisterState extends State<DistRegister> {
